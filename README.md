...
- **Variabili non definite**: ESLint con la regola `no-undef`, parser `@babel/eslint-parser` e `eslint-plugin-react`. È il controllo che intercetta i casi in cui un componente usa una prop che nessuno gli ha passato.
